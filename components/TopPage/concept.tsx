...
const arr = [
  ...
  { content: '自由がある証拠ともいえます。', marginLeft: '10%', isFlag: false },
  ...
  { content: '', marginLeft: '10%', isFlag: true },
  { content: 'そんな世の中にあふれる', marginLeft: '10%', isFlag: false },
  { content: '「ゆらぎ」', marginLeft: '30%', isFlag: false },
  { content: 'を、デザインを通して考えました。', marginLeft: '28%', isFlag: true },
];
...
export const Concept: NextPage = () => (
  <div className={styles.concept}>
    <div className={styles.concept__statement}>
      {arr.map((paragraph, i) => (
        <div
          style={{ marginLeft: paragraph.isFlag ? paragraph.marginLeft : paragraph.marginFirst }}
